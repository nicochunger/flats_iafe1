...
def reduc_bias(flat_entrada,master_bias,realizar,salida): #Esto se usa para corregir flas por bias
    if realizar is True: #Si la variable realizar es verdadera (Esa es basicamente si hay un master bias)
        iraf.imarith(flat_entrada,'-',master_bias,salida) #Le resta a los flats los bias
